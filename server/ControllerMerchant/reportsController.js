...
module.exports.accountSummary = async function (req, res) {
    ...
    if(id){
        ...
        let sql1 = "SELECT * FROM tbl_merchant_transaction WHERE user_id IN (?) ";
        let sql2 = "SELECT * FROM tbl_icici_payout_transaction_response_details WHERE users_id IN (?) ";
        let sql3 = "SELECT * FROM tbl_settlement WHERE user_id IN (?) ";
        if (from) {
        ...
        const test = "SELECT solution_apply_for_country FROM tbl_user WHERE id IN (?)";
        const testResult = await mysqlcon(test, [merchantIdArray]);
        const currencies = [];
        ...
        function ord_num(item) {
            ...
            switch (value) {
                case 1: {
                    let result1 = await mysqlcon(sql1,[merchantIdArray]);
                    let result2 = await mysqlcon(sql2,[merchantIdArray]);
                    let result3 = await mysqlcon(sql3,[merchantIdArray]);
