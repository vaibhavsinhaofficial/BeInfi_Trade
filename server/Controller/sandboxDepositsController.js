...
module.exports.downloadSandboxDeposits = async  (req, res)=> {
  try{
...
module.exports.depositsSandboxCards = async function(req, res) {
  try {
    let {to, from, status, merchantName, searchText} = req.body;
...
module.exports.changeSandboxDepositStatus = async function(req, res) {
  try {
