...
function Settlement() {
  ...
  const tabledatafetch = async () => {
    try {
      ...
      let result = await axios.post(
        `${baseUrl}/localsettlemetnt_Trans`,
        formData,
        config
      );
  ...
  const cardFetchData = async () => {
    ...
    axios
      .post(`${baseUrl}/localcardDetails`, formData, config)
      .then((res) => {
  ...
  const downloadExl = () => {
    ...
    axios.post(`${baseUrl}/localdownloadReportsc`, formData, config)
      .then((res) => {
