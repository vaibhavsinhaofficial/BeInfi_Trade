...
function RequestInternational() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      let result = await axios.post(`${baseUrl}/requestSettlement`, formData, config);
      ...
      navigate("/bankconnect/merchant/InternationalSettlement");
    } catch (error) {
      console.log(error);
    }
  };
    ...
    <>
      <div className="row align-items-center">
        ...
        <div className="col-2 text-end">
            <Link to="/bankconnect/merchant/InternationalSettlement">
              <button
                style={{
...
export default RequestInternational;
