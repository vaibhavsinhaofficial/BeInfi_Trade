...
function CommonInternational({
  ...
  buttonText,
    ...
    const [defualtCurrency, setDefaulCurrency] = useState([])
    ...
    let formData = new FormData();
        ...
        setDefaulCurrency(result.data.currencyResult)
    } catch (error) {
        console.log(error);
    }
    };
            ...
            <div className="col-12 dialogBlock1">
                <form action="" className="row justify-content-around" onSubmit={(e)=>handleSubmit(e)}>
                    ...
                    >
                        ...
                        {defualtCurrency.map((item, index) => (
                    ...
                    <input 
                        type="text" 
                        className="input1" 
                        value= {requestedAmount ? requestedAmount : 0}
                        onChange={(e) => setNet_amount_for_settlement(e.target.value)}
                    />
                    </div>
                    <div className="col-md-2 d-flex flex-column text-center">
                    <label
...
export default CommonInternational;
