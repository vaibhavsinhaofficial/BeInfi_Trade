...
function TeamSinglePayout() {
  ...
  const ReadData = async () => {
    try {
      ...
      axios
        .post(`${baseUrl}/teamSinglePayoutCurrency`, formData, config)
        .then((res) => {
  ...
  const BankCode = async (selectedCurrency ) => {
    try {
      ...
      axios
        .post(`${baseUrl}/teamSinglePayoutBankcodes`, value, config)
        .then((res) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      let result = await axios.post(`${baseUrl}/teamSinglePayoutCreate`, values, config);
...
export default TeamSinglePayout