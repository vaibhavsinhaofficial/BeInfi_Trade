  ...
  return (
    <>
      <div className="row justify-content-around  my-5 align-items-center">
        ...
        <div className="col-3">
          <Link to={`RequestTeamInternational`}>
...
function TeamInternationalSettlement() {
  ...
  const tabledatafetch = async () => {
    try {
      ...
      let result = await axios.post(
        `${baseUrl}/teamInternationalSettlement`,
        values,
        config
      );
  ...
  const FetchCardData = async () => {
    ...
    axios.post(`${baseUrl}/teamInternationalCardDetails`, values, config)
      .then((res) => {
  ...
  const downloadExl = () => {
    ...
    axios.post(`${baseUrl}/teamDownloadReportsc`, values, config)
      .then((res) => {
...
export default TeamInternationalSettlement;
