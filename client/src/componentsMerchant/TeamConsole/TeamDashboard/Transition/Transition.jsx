...
function Transition() {
  ...
  const todayApi = async () => {
    try {
      ...
      const { data } = await axios.post(`${baseUrl}/team_top_transaction_today`,value,config)
      ...
      <TableContainer className="tableblockdash">
        <Table sx={{ minWidth: 650 }} aria-label="simple table">
          <TableHead>
            <TableRow>
              <TableCell></TableCell>
              <TableCell style={{ fontWeight: "600",fontSize: "15px" }}>Name</TableCell>
              <TableCell style={{ fontWeight: "600",fontSize: "15px" }}>Date</TableCell>
              <TableCell style={{ fontWeight: "600",fontSize: "15px" }}>Amount</TableCell>
          ...
          <TableBody>
            {todayData?.length >= 1 ? (
              ...
              <TableRow>
                <TableCell style={{ fontWeight: "600",fontSize: "large" }} align="center">
                  No Data Found
                </TableCell>
              </TableRow>
            )}
