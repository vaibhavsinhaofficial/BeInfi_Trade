...
export default function TeamSidebar() {
  ...
  const SidebarLinkAdmin = [
    ...
    },
    {
        ...
        path: "TeamSinglePayout"
    },
    {
        name: "Local Settlement",
        iconUrl:
          `${local}`,
        path: "TeamLocalSettlement",
    },
    {
        name: "International Settlement",
        iconUrl:
          `${intersettlement}`,
        path: "TeamInternationalSettlement",
    },
    {
        name: "Reports",
        iconUrl:
      ...
      <Drawer variant="permanent" open={open} className="drawer">
        ...
        <List className="my-5">
        {
          isChecked === false ? (
            <>
              { 
                (Number(accountAssign) === 3 && usercode === "1") ?  SidebarLinkAdmin.map((item, index) => {
                return (
                ...
                }) : (Number(accountAssign) === 3 && usercode === "2") ? SidebarLinkManager.map((item, index) => {
                    return (
                    <div className="sidebarcontainer mb-3 " key={index}>
                        <NavLink
                        to={item.path}
                ...
                }) : (Number(accountAssign) === 3 && usercode === "3") ? SidebarLinkCashier.map((item, index) => {
                    return (
                    <div className="sidebarcontainer mb-3 " key={index}>
                        <NavLink
                        to={item.path}
                ...
                }) : SidebarLinkReporter.map((item, index) => {
                    return (
                    <div className="sidebarcontainer mb-3 " key={index}>
                        <NavLink
                        to={item.path}
