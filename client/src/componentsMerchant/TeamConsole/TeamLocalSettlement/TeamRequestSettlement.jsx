...
function TeamRequestSettlement() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate("/bankconnect/merchant/TeamLocalSettlement");
    } catch (error) {
      console.log(error);
    }
  };
    ...
    <>
      <div className="row align-items-center">
        ...
        <div className="col-2 text-end">
            <Link to="/bankconnect/merchant/TeamLocalSettlement">
              <button
                style={{
...
export default TeamRequestSettlement;
