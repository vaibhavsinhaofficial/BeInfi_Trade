...
import SandboxPayoutTable from "../Payouts/SandboxPayoutTable";
...
function SandboxPayouts() {
  ...
  useEffect(() => {
    ...
    axios
      .post(`${baseUrl}/sandboxPayoutheader`, formData, config)
      .then((res) => {
  ...
  const tabledatafetch = async () => {
    try {
      ...
      let result = await axios.post(`${baseUrl}/sandboxPayoutsDefault`, values, config);
  ...
  const downloadExl = () => {
    ...
    axios.post(`${baseUrl}/downloadSandboxPayoutReport`, formData, config)
      .then((res) => {
        const workSheet = XLSX.utils.json_to_sheet(res.data);
        const workBook = XLSX.utils.book_new();
        XLSX.utils.book_append_sheet(workBook, workSheet, "Sandbox");
        // Buffer
