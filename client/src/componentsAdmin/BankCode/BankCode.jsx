...
function PayinBankCodes({ authCreate, authRead, authUpdate, authDelete }) {
  ...
  const ReadData = async () => {
    try {
      ...
      formData.append("type", "0,1,2,3,4,5");
...
const PopUp = ({item, authUpdate, authDelete, ReadData }) => {
  ...
  const deleteRow = async (id, akontocode, code) => {
          ...
          <div className="d-flex  align-items-center justify-content-around flex-column">
            ...
            {authDelete ? (
              <button
                ...
                onClick={() => deleteRow(item.identification, item.akontocode, item.code)}
              >
                Delete
              </button>
            ) : null}
...
const DialogOpenModelAdd = ({ authCreate, ReadData }) => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      if (!title || !type || !bankCode || !merchantValue || !type1 || !bankServicesCharge || !code || !branch_code) {
                    ...
                    <div className="col-12 swapBox">
                      <form className="row justify-content-around"  onSubmit={handleSubmit}>
                        <div className="row">
                          ...
                          <div className="col-8">
                            <select className="form-control mb-3" onChange={(e)=> {typeDataFirst(e.target.value); setType(e.target.value)}}>
                  ...
                  <div className="col-12 swapBox">
                    <form className="row justify-content-around"  onSubmit={handleSubmit}>
                      ...
                      <div className="row">
                          ...
                          <div className="col-8">
                            <input type="text" value={branch_code} className="form-control mb-3" onChange={(e) => setBranch_code(e.target.value)} />
                          </div>
                        </div>
                      <div className="row">
                        <div className="col-4">
