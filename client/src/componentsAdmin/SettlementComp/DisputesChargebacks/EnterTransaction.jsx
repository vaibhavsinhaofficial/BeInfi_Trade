...
export default function EnterTransaction({fetchData}) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      let result = await axios.post(`${baseUrl}/createDisputes`, values, config);
              ...
              <form action="" className="row justify-content-around" onSubmit={handleSubmit}>
                  ...
                  <div className="col-md-3 d-flex flex-column text-center">
                    ...
                    <div className="d-flex justify-content-center align-items-center">
                      ...
                      onChange={(e)=>setDisputeCurrency(e.target.value)}
                      required
                      >
