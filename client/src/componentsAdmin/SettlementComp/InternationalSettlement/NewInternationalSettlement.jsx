...
const NewInternationalSettlement = ({ groupid }) => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            if (!user_id || !settlementType || !walletAdd || !wallet_type || !exchangeRate || !city || !zipcode || !country || !currency || !toCurrency || !accountN || !bankName || !account_name || !branchName || !swift || !requestedAmount || !fees || !availableBalance) {
          ...
          let values={settlementId, user_id, settlementType, currency, toCurrency, walletAdd, wallet_type, accountN, account_name,  availableBalance, remBalance, requestedAmount, fees, net_amount_for_settlement: (requestedAmount - fees), exchangeRate, bankName, branchName, city, zipcode, country, swift}
          const config = {
            headers: {
              "Content-type": "application/json",
              Accept: "application/json",
            ...
            let result = await axios.post(`${baseUrl}/requestInternational`, values, config);
            window.location.reload();
        } catch (error) {
          console.log(error);
        }
      ...
      <>
        <div>
            ...
            >
                ...
                >
                    New International Settlement Transaction
                </DialogTitle>
                <DialogContent>
                <div className="row">
                        ...
                        <form action="" className="row justify-content-around" onSubmit={(e)=>handleSubmit(e)}>
                            ...
                            <div className=" col-md-2 d-flex flex-column text-center  ">
                                ...
                                <input
                                    type="text" 
                                    className="input1" 
                                    value= {exchangeRate ? exchangeRate : 0}
...
export default NewInternationalSettlement