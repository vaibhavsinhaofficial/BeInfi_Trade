...
const EditLocalSettlement = ({ groupid, ID }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
          let values={id: ID, settlementId, user_id, toCurrency, requestedAmount, fees, accountN, bankName, branchName, swift, account_name, authorizer, settlementAmount}
          const config = {
            headers: {
              "Content-type": "application/json",
              Accept: "application/json",
          ...
          let result = await axios.post(`${baseUrl}/editLocalSettlement`, values, config);
          window.location.reload();
        } catch (error) {
          console.log(error);
        }
      ...
      <>
        <div>
            ...
            >
                ...
                >
                    Edit Local Settlement Transaction
                </DialogTitle>
                <DialogContent>
                <div className="row">
...
export default EditLocalSettlement